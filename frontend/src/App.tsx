...
const App: React.FC = () => {
  return (
    <Router>
      <Switch>
        <Route path="/season" render={() => <SeasonPage years={years} />} exact />
        <Route path="/" render={() => <HomePage years={years} />} exact />
        <Route path="/batting" render={() => <BattingPage years={years} />} exact />
        <Route path="/pitching" render={() => <PitchingPage years={years} />} exact />
