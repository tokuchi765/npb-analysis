...
// ReadManager 監督情報CSVを読み込む
func (TeamReader *TeamReader) ReadManager(csvPath string, teamID string, year string) (manager string) {
	path := csvPath + "/teams/stats/manager/" + getTeamInitial(teamID) + "_manager.csv"
	file, err := os.Open(path)
...
// ReadTeamExchangeStats 交流戦CSVを読み込む
func (TeamReader *TeamReader) ReadTeamExchangeStats(csvPath string, league string, year string) (teamExchangeMatchResults []teamData.TeamMatchResults) {
...
// ReadTeamPitching チーム投手成績CSVを読み込む
func (TeamReader *TeamReader) ReadTeamPitching(csvPath string, league string, year string) (teamPitching []teamData.TeamPitching) {
...
// ReadTeamBatting チーム打撃成績CSVを読み込む
func (TeamReader *TeamReader) ReadTeamBatting(csvPath string, league string, year string) (teamBatting []teamData.TeamBatting) {
