  ...
  try {
    const { data } = await rest.getParams(baseUri + '/search/batter-grades', {
      params: {
        ...
        hit: condition.Hit,
        singleThresholdType: condition.SingleThresholdType,
        single: condition.Single,
        doubleThresholdType: condition.DoubleThresholdType,
        double: condition.Double,
        tripleThresholdType: condition.TripleThresholdType,
        triple: condition.Triple,
        stolenBaseThresholdType: condition.StolenBaseThresholdType,
        stolenBase: condition.StolenBase,
