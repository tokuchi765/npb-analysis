...
func (GradesReader *GradesReader) setBatterGrades(line []string) (grades player.BATTERGRADES) {
	...
	grades.Team = line[1]
	grades.Games, _ = strconv.Atoi(line[2])
	grades.PlateAppearance, _ = strconv.Atoi(line[3])
	grades.AtBat, _ = strconv.Atoi(line[4])
	grades.Score, _ = strconv.Atoi(line[5])
	grades.Hit, _ = strconv.Atoi(line[6])
	grades.Double, _ = strconv.Atoi(line[7])
	grades.Triple, _ = strconv.Atoi(line[8])
	grades.HomeRun, _ = strconv.Atoi(line[9])
	grades.BaseHit, _ = strconv.Atoi(line[10])
	grades.RunsBattedIn, _ = strconv.Atoi(line[11])
	grades.StolenBase, _ = strconv.Atoi(line[12])
	grades.CaughtStealing, _ = strconv.Atoi(line[13])
	grades.SacrificeHits, _ = strconv.Atoi(line[14])
	grades.SacrificeFlies, _ = strconv.Atoi(line[15])
	grades.BaseOnBalls, _ = strconv.Atoi(line[16])
	grades.HitByPitches, _ = strconv.Atoi(line[17])
	grades.StrikeOut, _ = strconv.Atoi(line[18])
	grades.GroundedIntoDoublePlay, _ = strconv.Atoi(line[19])
	grades.BattingAverage, _ = strconv.ParseFloat(line[20], 64)
	grades.SluggingPercentage, _ = strconv.ParseFloat(line[21], 64)
	grades.OnBasePercentage, _ = strconv.ParseFloat(line[22], 64)
...
func (GradesReader *GradesReader) setPicherGrades(line []string) (grades player.PICHERGRADES) {
	...
	grades.Hold, _ = strconv.ParseFloat(line[6], 64)
	grades.HoldPoint, _ = strconv.ParseFloat(line[7], 64)
	grades.CompleteGame, _ = strconv.ParseFloat(line[8], 64)
	grades.Shutout, _ = strconv.ParseFloat(line[9], 64)
	grades.NoWalks, _ = strconv.ParseFloat(line[10], 64)
	grades.WinningRate, _ = strconv.ParseFloat(line[11], 64)
	grades.Batter, _ = strconv.ParseFloat(line[12], 64)
	grades.InningsPitched, _ = strconv.ParseFloat(line[13], 64)
	grades.Hit, _ = strconv.ParseFloat(line[14], 64)
	grades.HomeRun, _ = strconv.ParseFloat(line[15], 64)
	grades.BaseOnBalls, _ = strconv.ParseFloat(line[16], 64)
	grades.HitByPitches, _ = strconv.ParseFloat(line[17], 64)
	grades.StrikeOut, _ = strconv.ParseFloat(line[18], 64)
	grades.WildPitches, _ = strconv.ParseFloat(line[19], 64)
	grades.Balk, _ = strconv.ParseFloat(line[20], 64)
	grades.RunsAllowed, _ = strconv.ParseFloat(line[21], 64)
	grades.EarnedRun, _ = strconv.ParseFloat(line[22], 64)
	grades.EarnedRunAverage, _ = strconv.ParseFloat(line[23], 64)
